...
> Zhang, R., Chen, L., Oliver, L. D., Voineskos, A. N., Park, J. Y. (2024). SAN: mitigating spatial covariance heterogeneity in cortical thickness data collected from multiple scanners or sites. Human Brain Mapping [link](https://doi.org/10.1002/hbm.26692)
